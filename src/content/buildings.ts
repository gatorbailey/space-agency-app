...
export const BUILDINGS: BuildingDef[] = [
  { id: 'admin', name: 'Administration', label: 'Admin', blurb: 'Every desk reports here.', kind: 'admin', department: 'personnel', x: 90, y: 40, w: 100, h: 70 },
  { id: 'budget-office', name: 'Budget & Government Affairs', label: 'Budget Office', blurb: 'Appropriations and ongoing operations spend.', kind: 'office', department: 'budget', x: 218, y: 50, w: 112, h: 70 },
  ...
  { id: 'security', name: 'Security Depot', label: 'Security', blurb: 'Units, vehicles, and the perimeter.', kind: 'security', x: 90, y: 270, w: 92, h: 62 },
  { id: 'barracks', name: 'Astronaut Quarters', label: 'Astronaut Qtrs', blurb: 'The corps — active roster and reserves.', kind: 'barracks', department: 'astronaut-corps', upgradeTechIds: [TECH_IDS.trainingCenterTier], x: 208, y: 280, w: 122, h: 62 },
  ...
  { id: 'rd-lab', name: 'R&D Lab', label: 'R&D Lab', blurb: 'Knowledge research — one project at a time.', kind: 'lab', upgradeTechIds: [TECH_IDS.rdLabTier], x: 88, y: 500, w: 112, h: 82 },
  { id: 'fabrication', name: 'Fabrication Facility', label: 'Fabrication', blurb: 'Machinery and methods for making it here.', kind: 'factory', x: 220, y: 510, w: 112, h: 82 },
  ...
  { id: 'depot', name: 'Storage Depot', label: 'Depot', blurb: 'Stock on hand and contractor rush orders.', kind: 'depot', upgradeTechIds: [TECH_IDS.fuelingDepotTier], x: 93, y: 720, w: 104, h: 96 },
  { id: 'vab', name: 'Vehicle Assembly Building', label: 'VAB', blurb: 'Where the vehicle is stacked before rollout.', kind: 'vab', upgradeTechIds: [TECH_IDS.vabTier, TECH_IDS.crawlerTier], x: 227, y: 730, w: 100, h: 120 },
