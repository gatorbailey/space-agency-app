...
export const CARD_POOL: DecisionCardDef[] = [
  ...
  },
  {
    ...
    description: 'Rough seas held up the parts barge for three days.',
    severity: 'flag',
    site: SITE_NAME,
    department: 'infrastructure',
    availableFromDay: 18,
    ...
    options: [
      {
        ...
        description: 'Expensive, but keeps parts flowing.',
        effects: { budget: -800, parts: 10 },
      },
      {
        id: 'ride-it-out',
        label: 'Ride it out',
    ...
    options: [
      {
        ...
        description: 'A good price on a bulk restock of parts.',
        effects: { budget: -600, parts: 20 },
      },
      {
        id: 'pass',
        label: 'Pass on it',
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        id: 'risk-it',
        label: 'Risk it',
        description: 'Save the money; some stored provisions spoil in the heat.',
        effects: { provisions: -12 },
      },
    ],
  },
  {
    ...
    options: [
      {
        ...
        description: 'A small payout for a real parts-efficiency gain.',
        effects: { budget: -300, parts: 12 },
      },
      {
        id: 'file-it-away',
        label: 'File it away',
  ...
  {
    id: 'fuel-storage-leak',
    title: 'Propellant Storage Leak',
    description: 'A slow leak has been detected in a fuel storage tank.',
    severity: 'flag',
    site: SITE_NAME,
    department: 'infrastructure',
    availableFromDay: 20,
    cooldownDays: 30,
    deadlineDays: 4,
    onExpireOptionId: 'patch-and-monitor',
    options: [
      {
        id: 'emergency-repair',
        label: 'Emergency repair',
        description: 'Stops the loss fast, at real expense.',
        effects: { budget: -800, fuel: -5 },
      },
      {
        id: 'patch-and-monitor',
        label: 'Patch it and monitor',
        description: 'Cheaper, but the tank keeps bleeding fuel in the meantime.',
        effects: { fuel: -15 },
      },
    ],
  },
  {
    id: 'payload-scope-change',
    title: 'Payload Customer Changes Requirements',
    description: 'A research payload customer wants late changes to their instrument package.',
    severity: 'flag',
    site: SITE_NAME,
    department: 'budget',
    availableFromDay: 44,
    ...
    options: [
      {
        id: 'accommodate',
        label: 'Accommodate the changes',
        description: 'Costs money, but delivers a stronger payload package.',
        effects: { budget: -1000, payload: 8 },
      },
      {
        id: 'hold-firm',
        label: 'Hold the original scope',
        description: 'No cost, but an unhappy customer is bad for business.',
        effects: { sentiment: -2 },
      },
    ],
  },
  {
    id: 'eva-suit-recall',
    title: 'EVA Suit Recall Notice',
    description: 'A supplier flags a possible defect in a recent batch of EVA suits.',
    severity: 'flag',
    site: SITE_NAME,
    department: 'astronaut-corps',
    availableFromDay: 64,
    cooldownDays: 34,
    deadlineDays: 6,
    onExpireOptionId: 'inspect-and-patch',
    options: [
      {
        id: 'replace-immediately',
        label: 'Replace the batch immediately',
        description: 'Expensive, but the fleet is fully current.',
        effects: { budget: -1200, safetyGear: 5 },
      },
      {
        id: 'inspect-and-patch',
        label: 'Inspect and patch as needed',
        description: 'Cheaper, but some worn gear stays in service longer than it should.',
        effects: { safetyGear: -3, crewReadiness: -2 },
      },
    ],
  },
  {
    id: 'provisions-donation',
    title: 'Local Grocers Offer a Provisions Donation',
    description: 'A coalition of local grocers wants to donate a season’s worth of provisions.',
    severity: 'flag',
    site: SITE_NAME,
    department: 'press',
    availableFromDay: 24,
    ...
    options: [
      {
        ...
        description: 'A real stock boost and a nice local story.',
        effects: { provisions: 10, sentiment: 1 },
      },
      {
        id: 'decline',
