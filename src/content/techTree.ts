...
const INFRASTRUCTURE_TECH: TechNodeDef[] = [
  ...
  },
  {
    ...
    category: 'infrastructure',
    cost: { budget: -5000, materials: -30 },
  },
  {
    id: TECH_IDS.fuelingDepotTier,
    name: 'Fueling Depot Tier II',
    description: 'Expanded propellant and materials storage at the depot.',
    category: 'infrastructure',
    cost: { budget: -2500, materials: -15 },
  },
  {
