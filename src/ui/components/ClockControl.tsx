...
export function ClockControl() {
  ...
  return (
    <div className="flex items-center gap-4 bg-slate-950 px-4 py-2 text-slate-200">
      ...
      <div className="ml-auto flex items-center gap-1">
        {state.isHardPaused && (
          <span className="mr-2 rounded bg-red-900/60 px-2 py-1 text-xs font-semibold text-red-300">
